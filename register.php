...
<html>
	<head>
		<title>Create an account in hardy online canteen </title>
			...
			<form action="register.php" method="post" enctype="multipart/form-data">
				...
				<div class="row">
					<div class="col-12">
						...
						<input class="form-control" type="tel" placeholder="0771234567" name="mobile_num" required <?php echo 'value="'.$mobile_num.'"'?>>
					</div>
				</div>
				<div class="row">
					<div class="col-12">
